...
// Set this to your BM6 MAC address when known. Leave the default to scan by BLE
// name, which is slower but useful for first setup.
...
static constexpr size_t HISTORY_CAPACITY = 1440;
